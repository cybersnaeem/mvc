<form method="POST" id="filterData" action="<?php echo $this->getUrl()->getUrl('filter','admin\customer'); ?>">
                        ...
                        <?php else : ?>
                            ...
                            <?php foreach ($data->getData() as $value) : ?>
                                            <tr>
                                                ...
                                                <th>
                                                        <?php 
                                                            echo $this->getGroupName($value->group_id);
                                                        ?>
                                                    </th>
                                                    <th>
                                                        <?php
                                                                echo $this->getZipCode($value->customerId); 
                                                        ?>
                                                    </th>
