<form method="POST" id="filterData" action="<?php echo $this->getUrl()->getUrl('filter','admin\brand'); ?>">
            ...
            <tbody>
                        ...
                        <?php else : ?>
                            ...
                            <?php foreach ($data->getData() as $value) : ?>
                                            <tr>
                                                <th>
                                                    <img height="100px" width="100px" src="./Media/Brand/<?php echo $value->brandId ?>/<?php echo $value->image ?>" alt="Failed To Load Brand Image">
                                                </th>
